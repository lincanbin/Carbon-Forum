...
UE.I18N['ru'] = {
	'labelMap':{
		'anchor':'Автор', 'undo':'Отменить', 'redo':'Повторить', 'bold':'Жирный', 'indent':'Indent', 'snapscreen':'SnapScreen',
		...
		'pasteplain':'PastePlain', 'selectall':'SelectAll', 'print':'Печать', 'preview':'Предварительный просмотр',
		'horizontal':'Horizontal', 'removeformat':'RemoveFormat', 'time':'Время', 'date':'Дата',
