...
UE.I18N['ru'] = {
	'labelMap':{
		'anchor':'Автор', 'undo':'Отменить', 'redo':'Повторить', 'bold':'Жирный', 'indent':'Отступ', 'snapscreen':'SnapScreen',
		'italic':'Курсив', 'underline':'Подчеркивание', 'strikethrough':'Strikethrough', 'subscript':'SubScript','fontborder':'text border',
		'superscript':'SuperScript', 'formatmatch':'Format Match', 'source':'Источник', 'blockquote':'Блок цитаты',
		'pasteplain':'PastePlain', 'selectall':'Выбрать все', 'print':'Печать', 'preview':'Предварительный просмотр',
		'horizontal':'Horizontal', 'removeformat':'Удалить форматирование', 'time':'Время', 'date':'Дата',
		'unlink':'Unlink', 'insertrow':'Вставить строку', 'insertcol':'Вставить столбец', 'mergeright':'MergeRight', 'mergedown':'MergeDown',
		'deleterow':'Удалить строку', 'deletecol':'Удалить столбец', 'splittorows':'SplitToRows','insertcode':'вставить код',
		...
		'fontfamily':'Шрифт', 'fontsize':'Размер шрифта', 'paragraph':'Параграф','simpleupload':'Single Image','insertimage':'Multi Image','edittable':'Редактировать таблицу', 'edittd':'Edit Td','link':'Link',
		'emotion':'Смайлики', 'spechars':'Spechars', 'searchreplace':'SearchReplace', 'map':'BaiduMap', 'gmap':'GoogleMap',
		'insertvideo':'Видео', 'help':'Помощь', 'justifyleft':'JustifyLeft', 'justifyright':'JustifyRight', 'justifycenter':'JustifyCenter',
		'justifyjustify':'Justify', 'forecolor':'FontColor', 'backcolor':'BackColor', 'insertorderedlist':'OL',
		'insertunorderedlist':'UL', 'fullscreen':'Полноэкранный режим', 'directionalityltr':'EnterFromLeft', 'directionalityrtl':'EnterFromRight',
		...
		'webapp':'WebAPP', 'touppercase':'UpperCase', 'tolowercase':'LowerCase','template':'Template','background':'Background','inserttable':'Вставить таблицу',
		'music':'Музыка', 'charts': 'charts','drafts': 'Load from Drafts'
	},
	'insertorderedlist':{
		'num':'1,2,3...',
		'num1':'1),2),3)...',
	...
	'paragraph':{'p':'Параграф', 'h1':'Заголовок 1', 'h2':'Заголовок 2', 'h3':'Заголовок 3', 'h4':'Заголовок 4', 'h5':'Заголовок 5', 'h6':'Заголовок 6'},
	'fontfamily':{
		'songti':'Sim Sun',
		'kaiti':'Sim Kai',
		'heiti':'Sim Hei',
