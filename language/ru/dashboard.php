...
$Lang = array_merge($Lang, array(
	...
	'Forum_Descriptions' => 'Описание форума<br /><br />Которое показывается поисковой системе.<br />Не менее чем 150 символов. ',

	'Page_Show' => 'Показать ',
	'Page_Topics' => ' тем на странице. ',

	'Topic_Show' => 'Показать ',
	'Topic_Posts' => ' постов в теме. ',
	...
	'Refresh_Cache_Notice' => 'Обновление кэша может занять долгое время, так что будьте терпеливы. <br />Если статистические данные являются правильными, не нужно обновить кэш. ',
