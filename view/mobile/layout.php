...
<head>
	...
	<meta name="msapplication-TileImage" content="<?php echo StaticPath; ?>img/retinahd_icon.png" />
	<meta name="theme-color" content="#0088D1" />
	<link rel="icon" sizes="192x192" href="<?php echo StaticPath; ?>img/nice-highres.png" />
	<link rel="apple-touch-icon-precomposed" href="<?php echo StaticPath; ?>img/apple-touch-icon-57x57-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo StaticPath; ?>img/apple-touch-icon-72x72-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo StaticPath; ?>img/apple-touch-icon-114x114-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo StaticPath; ?>img/apple-touch-icon-144x144-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="180x180" href="<?php echo StaticPath; ?>img/retinahd_icon.png" />
	<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>/favicon.ico" />
	<link rel="stylesheet" type="text/css" href="<?php echo StaticPath; ?>css/mobile/appframework.css?version=<?php echo CARBON_FORUM_VERSION; ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo StaticPath; ?>css/mobile/style.css?version=<?php echo CARBON_FORUM_VERSION; ?>" />
			...
			<div class="panel" id="LoginPanel">
				...
				<form action="<?php echo $Config['WebsitePath']; ?>/login" method="post" onsubmit="JavaScript:this.Password.value=md5(this.Password.value);">
					<div class="input-group">
						...
						<p>
							<input type="text" name="VerifyCode" id="VerifyCode" placeholder="<?php echo $Lang['Verification_Code']; ?>"
								   onclick="document.getElementById('Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/captcha';"
								   value="" placeholder="<?php echo $Lang['Verification_Code']; ?>" />
						</p>
						<p>
							<img src="" id="Verification_Code_Img" style="cursor: pointer;width: 100%;" onclick="this.src+=''" align="middle" />
						</p>
						<p>
