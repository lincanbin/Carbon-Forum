						...
						<td width="auto" align="left">
							<label>
								<input type="text" name="VerifyCode" class="w200"
									   onfocus="document.getElementById('Forgot_Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/captcha';document.getElementById('Forgot_Verification_Code_Img').style.display='inline';"
