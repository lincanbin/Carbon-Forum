...
';
	...
	<link rel="apple-touch-icon-precomposed"
		  href="<?php echo StaticPath; ?>img/apple-touch-icon-57x57-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="72x72"
		  href="<?php echo StaticPath; ?>img/apple-touch-icon-72x72-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="114x114"
		  href="<?php echo StaticPath; ?>img/apple-touch-icon-114x114-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="144x144"
		  href="<?php echo StaticPath; ?>img/apple-touch-icon-144x144-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="180x180"
		  href="<?php echo StaticPath; ?>img/retinahd_icon.png"/>
	<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>/favicon.ico"/>
	<link
		href="<?php echo StaticPath; ?>css/default/style.css?version=<?php echo CARBON_FORUM_VERSION; ?>"
...
<div class="wrapper">
	...
	<div class="copyright">
		<p>
			<?php echo $Config['SiteName']; ?> Powered By © 2006-2018 <a href="https://www.94cb.com" target="_blank">Carbon
