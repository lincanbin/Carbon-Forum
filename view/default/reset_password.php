...
loadScript("<?php echo StaticPath; ?>js/default/account.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>",function() {});
</script>
<!-- main-content start -->
						...
						<td width="auto" align="left">
							<label>
								<input type="text" name="VerifyCode" class="w200"
									   onfocus="document.getElementById('Reset_Password_Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/captcha';document.getElementById('Reset_Password_Verification_Code_Img').style.display='inline';"
